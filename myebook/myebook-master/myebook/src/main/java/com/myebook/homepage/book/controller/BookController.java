...
public class BookController { 
	...
	public String insert(BookDTO book, MultipartFile file) throws Exception {
		...
		if(file.getOriginalFilename() != null && file.getOriginalFilename() != "") {
		 ...
		 book.setGdsImg(File.separator + "myebook"+ File.separator + "resources"+ 
				 File.separator + "imgUpload" + ymdPath + File.separator + fileName);
		System.out.println("파일 세파레이터"+File.separator);
			
		book.setThumbImg(File.separator + "myebook"+ File.separator + "resources"+ 
	...
	public String bookmodify(BookDTO book, @RequestParam("bkid") int bkid, Model model, MultipartFile file, HttpServletRequest req) throws Exception {
		 ...
		 book.setGdsImg(File.separator + "myebook"+ File.separator + "resources"+ File.separator + "imgUpload" + ymdPath + File.separator + fileName);
		 book.setThumbImg(File.separator + "myebook"+ File.separator + "resources"+ File.separator + "imgUpload" + ymdPath + File.separator + "s" + File.separator + "s_" + fileName);
		...
		public void postCKEditorImgUpload(HttpServletRequest req, HttpServletResponse res,
		 ...
		 try {
		  ...
		  /*printWriter.println("<script type='text/javascript'>"
				     ...
				     +"</script>"); System.out.println(printWriter);
		  printWriter.flush();*/
