...
//		public String getList(@RequestParam("cn") int cate_name, @RequestParam("l") int level, Model model)
//		throws Exception {
...
//	}
	...
	public void check_id(@RequestParam("user_id") String user_id, 
	...
	public void check_nickname(@RequestParam("nickname") String nickname, 
			HttpServletResponse response) throws Exception{
	...
	public void approval_member(@ModelAttribute MemberDTO member, 
			HttpServletResponse response) throws Exception{
	...
	public void find_pw(@ModelAttribute MemberDTO member, 
			HttpServletResponse response) throws Exception{	
	...
	public String update_pw(@ModelAttribute MemberDTO member, 
	...
	public String withdrawal_form(@ModelAttribute MemberDTO member, 
				HttpSession session, HttpServletResponse response) throws Exception{
