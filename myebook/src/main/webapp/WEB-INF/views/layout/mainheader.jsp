					...
					<c:when test="${member.admin_status != true}">
						<li class="nav-item dropdown show"><a
							...
							<div class="dropdown-menu" aria-labelledby="dropdown03">
								...
								<a class="dropdown-item" href="#">내 서재</a> 
								<a class="dropdown-item" href="./logout.do">로그아웃</a>
 ...
 <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item" >
       <img class="bd-placeholder-img" src = "images/holton2.jpg" 
 ...
 <div class="slider" id="featured-content" >
         <div>
            <a href="#">             
               ...
               <h2>[#1]Best Romanse book</h2>
            </a>
         </div>
         <div>
            <a href="#">
              <img src="images/mermaid.jpg" alt="">
               <h2>[#2]Best Fantasy book</h2>
            </a>
         </div>
         <div>
            <a href="#">
               <img src="images/jumu.jpg" alt="">
               <h2>[#3]Best Heroism book</h2>
            </a>
         </div>
         <div>
            <a href="#">
              <img src="images/ET.jpg" alt="">
               <h2>[#4]Best SF book</h2>
            </a>
         </div>
         <div>
            <a href="#">               
